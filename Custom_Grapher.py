# -*- coding: utf-8 -*-
"""
Created on Fri Feb  2 03:38:06 2024
...
def Custom_grapher(filenames,title,xlimits,ylimits,txt,legend,gridlines,xlabel,ylabel,xcolumn,
    ...
    while(i < len(filenames)):
        if txt == False:
            ...
            datalistX[i],datalistY[i]=np.loadtxt(fname="C:/Users/isaac/OneDrive/Documents/Electrochemistry Program/Lab 2/Project 1/Week 2/" + filenames[i] + ".txt", skiprows=1, unpack=True,delimiter=customDelimiter
                ,usecols=(xcolumn,ycolumn))
