# -*- coding: utf-8 -*-
"""
Created on Sun Jan 28 18:35:09 2024
...
def TV_grapher(const #Normalizing constant to turn current input into current density output if desired
    ...
    ax.set_xlabel('Time (s)') # set the label of the y-axis
    ...
    while(i < len(filenames)):
        if txt == False:
            ...
            datalistX[i],datalistY[i]=np.loadtxt(fname="C:/Users/isaac/OneDrive/Documents/Electrochemistry Program/Lab/Project 5/Data Files/" + filenames[i] + ".txt", skiprows=1, unpack=True,
                   usecols=(0,1))
